...
func void B_Kapitelwechsel(var int neues_Kapitel)
{
	...
	if(neues_Kapitel == 1)
	{
		...
		IntroduceChapter("","","chapter1.tga","levelup.wav",6000);
	...
	else if(neues_Kapitel == 2)
	{
		...
		B_InsertInExtremo();
		IntroduceChapter("","","chapter2.tga","levelup.wav",6000);
	...
	else if(neues_Kapitel == 3)
	{
		...
		IntroduceChapter("","","chapter3.tga","levelup.wav",6000);
	}
	else if(neues_Kapitel == 4)
	{
		...
		IntroduceChapter("","","chapter4.tga","levelup.wav",6000);
	}
	else if(neues_Kapitel == 5)
	{
		...
		CreateInvItems(ORG_855_Wolf,sld_armor_m,1);
		EquipItem(ORG_855_Wolf,sld_armor_m);
		...
		IntroduceChapter("","","chapter5.tga","levelup.wav",6000);
	}
	else if(neues_Kapitel == 6)
	{
		...
		IntroduceChapter("","","chapter6.tga","levelup.wav",6000);
	};
};
