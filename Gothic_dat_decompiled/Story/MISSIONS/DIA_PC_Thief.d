...
func void Info_Diego_Brief_Info()
{
	...
	B_LogEntry(CH1_MESSAGEKDF,"Magowie Ognia przebywaj¹ wewn¹trz zamku, jednak¿e jest on czêœci¹ Starego Obozu i wstêp tam maj¹ jedynie ludzie Gomeza.");
};
...
func void Info_Diego_JoinAnalyze_Info()
{
	...
	{
		AI_Output(self,hero,"Info_Diego_Points_11_30");	//Ty chyba sobie ¿arty stroisz, ch³opcze. Przecie¿ nikt ciê tu nawet nie zna!
	};
};
...
instance info_diego_münzen(C_Info)
{
	...
	permanent = 0;
	description = "S³ysza³em, ¿e zbierasz stare monety.";
};
...
{
	AI_Output(hero,self,"Info_Diego_Münzen_15_00");	//S³ysza³em, ¿e zbierasz stare monety.
	AI_Output(self,hero,"Info_Diego_Münzen_11_01");	//To prawda. A od kogoœ to us³ysza³?
	AI_Output(self,hero,"Info_Diego_Münzen_11_02");	//Ach, zreszt¹ niewa¿ne. Jak jakieœ znajdziesz, to mo¿esz je do mnie przynieœæ.
	AI_Output(self,hero,"Info_Diego_Münzen_11_03");	//Nie robisz tego oczywiœcie za darmo. Dam ci za ka¿d¹ monetê bry³kê rudy.
	AI_Output(self,hero,"Info_Diego_Münzen_11_04");	//Umowa stoi?
	Info_ClearChoices(info_diego_münzen);
	Info_AddChoice(info_diego_münzen,"Stoi.",info_diego_münzen_okay);
	Info_AddChoice(info_diego_münzen,"Chcê wiêcej.",info_diego_münzen_mehr);
};

func void info_diego_münzen_okay()
{
	AI_Output(hero,self,"Info_Diego_OKAY_15_00");	//Stoi.
	AI_Output(self,hero,"Info_Diego_OKAY_11_01");	//Œwietnie. Przynieœ mi wszystkie stare monety, jakie tylko zdo³asz znaleŸæ.
	AI_Output(self,hero,"Info_Diego_OKAY_11_02");	//Pamiêtaj. Oferujê w zamian bry³kê rudy za ka¿d¹ monetê.
	Info_ClearChoices(info_diego_münzen);
};

func void info_diego_münzen_mehr()
{
	AI_Output(hero,self,"Info_Diego_MEHR_15_00");	//Chcê wiêcej.
	AI_Output(self,hero,"Info_Diego_MEHR_11_00");	//Wiêcej niestety nie mogê ci zaoferowaæ.
	AI_Output(self,hero,"Info_Diego_MEHR_11_01");	//Zreszt¹ w kolonii i tak z nimi za wiele nie zrobisz.
	AI_Output(hero,self,"Info_Diego_MEHR_11_02");	//No dobra, zgoda.
	AI_Output(self,hero,"Info_Diego_MEHR_11_03");	//Œwietnie. Przynieœ mi zatem wszystkie stare monety, jakie tylko zdo³asz znaleŸæ.
	AI_Output(self,hero,"Info_Diego_MEHR_11_04");	//Pamiêtaj. Oferujê w zamian bry³kê rudy za ka¿d¹ monetê.
	Info_ClearChoices(info_diego_münzen);
};
...
instance INFO_DIEGO_MüNZENABGEBEN(C_Info)
{
	...
	important = 0;
	permanent = 1;
	description = "Oto wszystkie zgromadzone przeze mnie monety.";
};
...
{
	AI_Output(hero,self,"Info_Diego_MünzenAbgeben_16_01");	//Oto wszystkie zgromadzone przeze mnie monety.
	AI_Output(self,hero,"Info_Diego_MünzenAbgeben_12_02");	//Dobra robota. Daj je tutaj.
	xp_standart = 1;
	...
	Npc_RemoveInvItems(other,ItMi_Stuff_OldCoin_01,Npc_HasItems(other,ItMi_Stuff_OldCoin_01));
	Npc_RemoveInvItems(other,ItMi_Stuff_OldCoin_02,Npc_HasItems(other,ItMi_Stuff_OldCoin_02));
	AI_Output(self,hero,"Info_Diego_MünzenAbgeben_12_03");	//No, to tak jak uzgadnialiœmy - bry³ka rudy za ka¿d¹ monetê.
	CreateInvItems(self,ItMiNugget,player_muenzen);
	B_GiveInvItems(self,other,ItMiNugget,player_muenzen);
	CreateInvItems(other,ItMiNugget,player_muenzen_2);
	B_GiveXP(xp_playermuenzen);
	AI_Output(self,hero,"Info_Diego_MünzenAbgeben_12_04");	//Jeœli jeszcze jakieœ znajdziesz, to wiesz, do kogo siê zg³osiæ.
};
...
{
	AI_Output(self,other,"DIA_Thief_SCBARON_15_00");	//Tylko mi nie mów, ¿e teraz jesteœ jednym z Magnatów?
	AI_Output(self,other,"DIA_Thief_SCBARON_15_01");	//Hehe, niez³y jesteœ!
	AI_StopProcessInfos(self);
};
