...
{
	var C_Npc Templer;
	AI_Output(hero,self,"Info_TPL_1441_FirstWarn_Condition_NAMIB_15_01");	//Przysy³a mnie Baal Namib. Ponoæ Y'Berionowi potrzebna jest pomoc Nowicjusza.
	AI_Output(self,hero,"Info_TPL_1441_FirstWarn_Condition_NAMIB_13_02");	//Baal Namib ju¿ nas o tym poinformowa³. Mo¿esz przejœæ.
	Info_ClearChoices(Info_TPL_1441_FirstWarn);
	Templer = Hlp_GetNpc(TPL_1442_Templer);
	hero.aivar[AIV_GUARDPASSAGE_STATUS] = AIV_GPS_BEGIN;
	self.aivar[AIV_PASSGATE] = TRUE;
