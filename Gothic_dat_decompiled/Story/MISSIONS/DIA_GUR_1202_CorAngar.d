...
func void GUR_1202_CorAngar_WANNABETPL_Info()
{
	...
	else if(hero.level >= 10)
	{
		...
		B_LogEntry(GE_BECOMEGURU,"Skoro do³¹czy³em do Stra¿ników Œwi¹tynnych, œcie¿ka Guru jest ju¿ dla mnie zamkniêta.");
...
func void Info_CorAngar_FindHerb_Info()
{
	...
	AI_Output(self,other,"Mis_3_NC_CorAngar_FindHerb_08_04");	//Za³atw piêæ najmocniejszych zió³ uzdrawiaj¹cych jakie mo¿na znaleŸæ na bagnach!
	AI_Output(self,other,"Mis_3_NC_CorAngar_FindHerb_08_06");	//Potem udaj siê do Caine'a, jak ju¿ tylko je zdobêdziesz. On bêdzie w stanie uwarzyæ ci z nich eliksir.
	...
	B_LogEntry(CH3_FindHerbs,"Y'Berion nadal nie odzyska³ przytomnoœci. Cor Angar nakaza³ mi znaleŸæ piêæ leczniczych zió³ o silnym dzia³aniu. Jak ju¿ je tylko zdobêdê, mam je przekazaæ Caine'owi, który uwarzy z nich silny eliksir leczniczy.");
};
...
func void Info_CorAngar_FindHerb_Success_Info()
{
	...
	B_LogEntry(CH3_FindHerbs,"Za³atwi³em Cor Angarowi obiecany eliksir. Miejmy tylko nadziejê, ¿e nie jest jeszcze za póŸno...");
