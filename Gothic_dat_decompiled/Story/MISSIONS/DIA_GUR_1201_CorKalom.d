...
func void GUR_1201_CorKalom_Experimente_Info()
{
	...
	{
		AI_Output(self,other,"GUR_1201_CorKalom_Experimente_10_01");	//Moje badania dotycz¹ spraw, o których nie masz najmniejszego pojêcia, ch³opcze, wiêc przestañ zawracaæ mi g³owê!
		AI_Output(self,other,"GUR_1201_CorKalom_Experimente_10_02");	//Ponadto badam rozmaite dzia³ania bagiennego ziela, kiedy to zmiesza siê je z ró¿nymi sk³adnikami.
	};
};
...
func void GUR_1201_CorKalom_JoinPSI_Info()
{
	...
	{
		AI_Output(other,self,"GUR_1201_CorKalom_JoinPSI_16_04");	//Baal Lukor chce, bym zosta³ przeszkolony na godnego s³ugê Œni¹cego.
		counter = counter + 1;
	};
	...
	if(hero.level >= 5)
	{
		if(counter >= 4)
		{
			...
			B_LogEntry(CH1_JoinOC,"Odk¹d zgodzi³em siê przystaæ do Bractwa Œni¹cego nie mogê ju¿ liczyæ na zostanie przyjêtym do Cieni Gomeza.");
...
func void GUR_1201_CorKalom_JoinPSI2_Info()
{
	...
	AI_Output(self,other,"GUR_1201_CorKalom_JoinPSI_11_15");	//We¿ ten amulet. Dziêki niemu siepacze Gomeza bêd¹ wiedzieli, ¿e przychodzisz od nas.
	CreateInvItems(self,ItMiJoint_3,30);
	B_GiveInvItems(self,hero,ItMiJoint_3,30);
	CreateInvItems(hero,ItMi_Amulet_Psi_01,1);
...
func void Info_Kalom_DrugMonopol_Info()
{
	...
	AI_Output(self,other,"Mis_1_Psi_Kalom_DrugMonopol_10_02");	//Chc¹ odebraæ nam naszych klientów, a my nie mo¿emy sobie na to pozwoliæ.
...
func void Info_Kalom_Success_Info()
{
	...
	else if((Stooges_Fled == TRUE) || (Npc_IsDead(Jacko) && Npc_IsDead(Renyu) && Npc_IsDead(Killian)))
	{
		...
		AI_Output(self,other,"Mis_1_Psi_Kalom_Success_10_05");	//Zaskakujesz mnie. Chyba ciê trochê nie doceni³em. Mo¿e jednak bêdzie z ciebie jakiœ po¿ytek.
		AI_Output(self,other,"Mis_1_Psi_Kalom_Success_10_06");	//Pomów teraz z Baalami.
...
func void Info_CorKalom_Belohnung_Info()
{
	...
	Info_AddChoice(Info_CorKalom_Belohnung,"Daj mi napoje many.",Info_CorKalom_Belohnung_MANA);
};
...
{
	AI_Output(other,self,"Info_CorKalom_Belohnung_MANA_15_00");	//Daj mi napoje many.
...
{
	AI_Output(self,other,"GUR_1201_CorKalom_Tattoos_10_01");	//Bym zapomnia³. Baal Namib chce siê z tob¹ widzieæ na bagnie.
	AI_Output(other,self,"GUR_1201_CorKalom_Tattoos_10_02");	//A czego chce?
	AI_Output(self,other,"GUR_1201_CorKalom_Tattoos_10_03");	//Pewnie sam ci powie. IdŸ ju¿ ch³opcze, marnujesz mój cenny czas!
	namib_ritual = LOG_RUNNING;
	Log_CreateTopic(CH1_RITUAL,LOG_MISSION);
	Log_SetTopicStatus(CH1_RITUAL,LOG_RUNNING);
	B_LogEntry(CH1_RITUAL,"Cor Kalom wspomnia³, ¿e Baal Namib chce siê ze mn¹ widzieæ. Sam oczywiœcie nie jest sk³onny powiedzieæ, o co dok³adnie chodzi.");
