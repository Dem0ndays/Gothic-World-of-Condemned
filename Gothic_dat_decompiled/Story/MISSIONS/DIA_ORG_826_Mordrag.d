...
func void Org_826_Mordrag_Courier_Info()
{
	...
	B_LogEntry(CH1_MESSAGEKDF,"Jako cz³onek Nowego Obozu móg³bym siê dostaæ do zamku. Muszê jednak przed tym do³¹czyæ do Szkodników, potem ju¿ jako pos³aniec Magów Wody bêdê móg³ wkroczyæ do zamku.");
};
...
instance Org_826_Mordrag_JoinNewcamp(C_Info)
{
	...
	permanent = 0;
	description = "A gdybym chcia³ do³¹czyæ do Nowego Obozu... móg³byœ mi pomóc?";
};
...
{
	AI_Output(self,other,"DIA_Mordrag_NowORG_09_00");	//A wiêc naprawdê ci siê uda³o? Podj¹³eœ w³aœciw¹ decyzjê.
};
...
instance org_826_mordrag_hunossword(C_Info)
{
	...
	permanent = 1;
	description = "Chcia³bym odkupiæ miecz, który sprzeda³ ci Jesse.";
};
...
{
	AI_Output(other,self,"Org_826_Mordrag_HunosSword_15_00");	//Chcia³bym odkupiæ miecz, który sprzeda³ ci Jesse.
	AI_Output(self,other,"Org_826_Mordrag_HunosSword_12_01");	//Ach tak? W takim razie trochê ciê to bêdzie kosztowaæ.
	AI_Output(other,self,"Org_826_Mordrag_HunosSword_12_02");	//Ile sobie za niego liczysz?
	AI_Output(self,other,"Org_826_Mordrag_HunosSword_12_03");	//200 bry³ek i jesteœmy kwita.
	Info_ClearChoices(org_826_mordrag_hunossword);
	Info_AddChoice(org_826_mordrag_hunossword,"Mo¿e póŸniej.",org_826_mordrag_hunossword_back);
	Info_AddChoice(org_826_mordrag_hunossword,"W porz¹dku.",org_826_mordrag_hunossword_takeit);
};
...
{
	AI_Output(other,self,"Org_826_Mordrag_HunosSword_TakeIt_15_00");	//Dobra, masz tu swoje 200 bry³ek.
	if(Npc_HasItems(other,ItMiNugget) >= 200)
	{
		AI_Output(self,other,"Org_826_Mordrag_HunosSword_TakeIt_12_01");	//Œwietnie, a oto twój miecz. Ubi³eœ dobry interes.
		B_GiveInvItems(other,self,ItMiNugget,200);
		CreateInvItem(self,bloodwyns_schwert);
		B_GiveInvItems(self,other,bloodwyns_schwert,1);
		Info_ClearChoices(org_826_mordrag_hunossword);
		mordrag_schwert = TRUE;
		B_LogEntry(CH1_HUNOLOSTSWORD,"Mordrag sprzeda³ mi ten miecz bez wiêkszych k³opotów. Teraz ju¿ tylko muszê zanieœæ go Huno z powrotem.");
	}
	else
	{
		AI_Output(self,other,"Org_826_Mordrag_HunosSword_TakeIt_12_02");	//A przelicz to sobie jeszcze raz, bo ja tu ¿adnych 200 bry³ek nie widzê.
	};
};
...
instance ORG_826_MORDRAG_SECT(C_Info)
{
	...
	permanent = 1;
	description = "Co ty tu robisz w ich obozie?";
};
...
{
	AI_Output(other,self,"Org_826_Mordrag_Sect_15_00");	//Co ty tu robisz w ich obozie?
	AI_Output(self,other,"Org_826_Mordrag_Sect_11_01");	//Nasz przywódca Lares mnie tu pos³a³. Paru Nowicjuszy powiedzia³o mi, ¿e ma siê tu odbyæ wielkie przywo³anie.
	AI_Output(self,other,"Org_826_Mordrag_Sect_15_02");	//Dlatego w³aœnie tu jestem. Mam na to wszystko mieæ baczenie.
	AI_Output(self,other,"Org_826_Mordrag_Sect_11_03");	//Ale póki jeszcze nic siê tutaj specjalnie wynios³ego nie dzieje, ograniczam siê do prowadzenia interesów.
};
