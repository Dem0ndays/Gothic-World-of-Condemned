...
func void PC_Psionic_Exit_Info()
{
	...
	{
		AI_Output(self,hero,"Info_Lester_EXIT_05_01");	//Niech Œni¹cy ma ciê w swojej opiece!
	}
	else
	{
...
func void DIA_Lester_WeitWeg_Info()
{
	...
	B_LogEntry(CH1_JoinPsi,"Aby przekonaæ do siebie Baal Namiba, mam zwróciæ siê do Lestera, gdy wielki Guru bêdzie w pobli¿u i porozmawiaæ z nim o bogach i Œni¹cym.");
	Lester_Show = TRUE;
};
...
func void PC_Psionic_GUIDEFIRST_Info()
{
	...
	Info_AddChoice(PC_Psionic_GUIDEFIRST,"... do wolnej chaty.",pc_psionic_guidefirst_hut);
};
...
{
	AI_Output(other,self,"PC_Psionic_GUIDEFIRST_HUT_Info_15_01");	//... do wolnej chaty.
	AI_Output(self,other,"PC_Psionic_GUIDEFIRST_HERB_Info_05_02");	//ChodŸ za mn¹!
	LesterGuide = 5;
	AI_StopProcessInfos(self);
...
{
	AI_Output(self,other,"PC_Psionic_HUT_Info_06_10");	//Do chaty dostaniesz siê po tej drabinie.
	AI_Output(self,other,"PC_Psionic_HUT_Info_06_12");	//Tylko pamiêtaj, ¿e zazwyczaj pozwalamy spaæ w naszych chatach jedynie cz³onkom naszego obozu i przybyszom.
	AI_Output(self,other,"PC_Psionic_HUT_Info_06_13");	//Nie zapomnij o tym, gdybyœ czasem chcia³ siê u nas po³o¿yæ jako dzia³acz jakiegoœ innego obozu.
	AI_Output(self,other,"PC_Psionic_HUT_Info_06_14");	//Stra¿nicy mogliby staæ siê doœæ nieprzyjemni, gdybyœ nie trzyma³ siê naszych przepisów.
	AI_Output(self,other,"PC_Psionic_HUT_Info_06_11");	//Rozejrzyj siê tam trochê, poczekam tu na ciebie. Tylko niech ci to nie zajmie ca³ego dnia.
	LesterGuide = 0;
	Npc_ExchangeRoutine(self,"START");
	AI_StopProcessInfos(self);
	TA_BeginOverlay(self);
...
func void PC_Psionic_BROTHERHOOD_TODO_Info()
{
	...
	{
		AI_Output(self,other,"PC_Psionic_BROTHERHOOD_TODO_05_05");	//Porozmawiaj z Baal Namibem. Jako, ¿e jesteœ jednym z naszych Nowicjuszy, potrzebne ci bêdzie pozwolenie od Guru, by móc wejœæ na œwi¹tynne wzgórze. On przeka¿e stra¿nikowi, by ciê wpuœci³.
	};
...
{
	AI_Output(hero,self,"Info_SFB_1_DieLage_15_00");	//Jak siê masz?
	...
	AI_Output(hero,self,"Info_lester_DIEGOMILTEN_15_01");	//Chc¹ siê z tob¹ spotkaæ, tam gdzie zawsze.
...
instance DIA_LESTER_MYOWNHUT(C_Info)
{
	...
	permanent = 1;
	description = "Mogê siê tu gdzieœ zdrzemn¹æ?";
};
...
{
	AI_Output(other,self,"DIA_Lester_Hut_12_10");	//Mogê siê tu gdzieœ zdrzemn¹æ?
	AI_Output(self,other,"DIA_Lester_Hut_12_20");	//Tak, zwolni³a siê niedawno chata blisko centrum obozu.
	AI_Output(self,other,"DIA_Lester_Hut_12_30");	//Jeœli chcesz, mogê ciê tam zaprowadziæ.
};
