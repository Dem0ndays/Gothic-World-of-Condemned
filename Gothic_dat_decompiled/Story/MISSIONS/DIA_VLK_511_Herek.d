...
instance dia_herek_kyle(C_Info)
{
	...
	permanent = 0;
	description = "Na przysz³oœæ radzê siê trzymaæ od chaty Kyle'a z daleka!";
};
...
{
	AI_Output(other,self,"DIA_Herek_Kyle_15_00");	//Na przysz³oœæ radzê siê trzymaæ od chaty Kyle'a z daleka!
	AI_Output(self,other,"DIA_Herek_Kyle_15_01");	//Dobra, cz³owieku, daj¿e mi ju¿ spokój...
	B_LogEntry(CH1_KYLE,"Da³em jasno Herekowi do zrozumienia, ¿e nie ma czego szukaæ w chacie Kyle'a. Jeœli ma choæ krztynê rozumu w g³owie, to da sobie z tym spokój. Czas przekazaæ Kyle'owi dobre wieœci.");
	AI_StopProcessInfos(self);
};
