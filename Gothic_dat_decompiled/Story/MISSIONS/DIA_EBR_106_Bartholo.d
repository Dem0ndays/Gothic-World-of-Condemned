...
func void Info_Bartholo_PERM_Info()
{
	...
	if(bartholo_trade == FALSE)
	{
		...
		B_LogEntry(GE_TraderOC,"Bartholo, jeden z Magnatów Starego Obozu, prowadzi handel rozmaitymi towarami.");
		bartholo_trade = TRUE;
	};
};
...
{
	AI_Output(self,other,"DIA_Bartholo_SCBARON_15_00");	//Ty jesteœ tym nowym stra¿nikiem Gomeza?
	AI_Output(self,other,"DIA_Bartholo_SCBARON_15_01");	//Nie po¿a³ujesz swojej decyzji.
	AI_StopProcessInfos(self);
};
