...
{
	AI_Output(self,other,"DIA_KDW_Myxir_HeroDMB_15_00");	//Co? Ty... przeszed³eœ na czarn¹ stronê?
	AI_Output(self,other,"DIA_KDW_Myxir_HeroDMB_15_01");	//Saturas z pewnoœci¹ nie bêdzie zadowolony!
	AI_StopProcessInfos(self);
};
