...
func void Info_Bloodwyn_PayForJesse_Info()
{
	...
	if(Npc_HasItems(other,ItMiNugget) >= 10)
	{
		...
		B_GiveInvItems(other,self,ItMiNugget,10);
		B_LogEntry(CH1_JESSE,"Zap³aci³em Bloodwynowi 10 bry³ek rudy za Jessego. Chocia¿ i tak twierdzi³, ¿e powinienem pierw zap³aciæ SWOJ¥ zaliczkê.");
		AI_StopProcessInfos(self);
	}
	else
	{
...
{
	AI_Output(self,other,"GRD_233_Bloodwyn_GETOUT_Info_08_01");	//Ktoœ taki jak ty móg³by tutaj zajœæ naprawdê daleko. A zamiast tego polaz³eœ do tych zjadaczy ry¿u z Nowego Obozu. Zje¿d¿aj!
	AI_StopProcessInfos(self);
};
...
func void Info_Bloodwyn_DIE_Info()
{
	...
	if((oldHeroGuild == GIL_STT) || (oldHeroGuild == GIL_GRD) || (oldHeroGuild == GIL_KDF))
	{
		...
		{
			AI_Output(self,hero,"Info_Bloodwyn_DIE_09_03");	//No proszê, kogo my tu mamy? To wstyd i hañba nazywaæ siebie Magnatem!
		}
		else
		{
