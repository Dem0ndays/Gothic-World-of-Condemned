...
instance Info_Cronos_KALOM(C_Info)
{
	...
	permanent = 0;
	important = 0;
	description = "Cor Kalom opuœci³ obóz Bractwa z grup¹ fanatycznych Stra¿ników Œwi¹tynnych!";
};
...
func void KDW_604_Cronos_GREET_Info()
{
	...
	AI_Output(self,other,"KDW_604_Cronos_GREET_Info_08_04");	//Jednak¿e pohandlujê z tob¹ dopiero wtedy, kiedy do³¹czysz do naszego Krêgu. Nie odsprzedajemy naszych run ludziom z innych obozów.
	AI_Output(self,other,"KDW_604_Cronos_GREET_Info_08_03");	//Co mogê dla ciebie zrobiæ?
	Log_CreateTopic(GE_TraderNC,LOG_NOTE);
	B_LogEntry(GE_TraderNC,"Cronos sprzedaje magiczne przedmioty, takie jak runy, zwoje i pierœcienie. Znajdê go przy kracie nad wielkim kopcem rudy. Pohandluje on ze mn¹ jednak dopiero wtedy, gdy bêdê cz³onkiem Wodnego Krêgu.");
