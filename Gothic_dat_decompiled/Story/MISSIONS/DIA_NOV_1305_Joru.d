...
{
	AI_Output(self,other,"DIA_Joru_SmokingTeacher_15_00");	//Jesteœ tu nowy, co? Mia³eœ ju¿ okazjê posmakowaæ naszego ziela?
	AI_Output(self,other,"DIA_Joru_SmokingTeacher_07_01");	//Jeœli nie, powinieneœ to jak najszybciej uczyniæ. Wiesz, jest naprawdê dobre. Ono otwiera twój umys³ na s³owa Œni¹cego.
	AI_Output(self,other,"DIA_Joru_SmokingTeacher_07_02");	//ChodŸ, do³¹cz do nas i uwolnij swego ducha. Przygotuj siê na podró¿.
	AI_Output(self,other,"DIA_Joru_SmokingTeacher_07_03");	//Duchow¹ podró¿. Naucz siê korzystaæ z si³y umys³u. Naucz siê j¹ kontrolowaæ.
	AI_Output(self,other,"DIA_Joru_SmokingTeacher_07_04");	//Otwórz siê na poszukiwania, zacznij wypatrywaæ, odkryj prawdê. Wszystkiego bêdziesz w stanie doœwiadczyæ, jeœli tylko do nas do³¹czysz.
};
...
{
	AI_Output(self,other,"Nov_1305_Joru_WELCOME_Info_08_11");	//Widzê, ¿e by³eœ szybszy ode mnie i uda³o ci siê zostaæ Guru. Dobra robota, przyjacielu.
	AI_StopProcessInfos(self);
};
