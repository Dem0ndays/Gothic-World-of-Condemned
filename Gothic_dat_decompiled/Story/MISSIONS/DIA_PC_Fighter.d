...
func void Dia_Gorn_HutFree_Info()
{
	...
	AI_Output(self,other,"DIA_Gorn_HutFree_09_02");	//Tylko uwa¿aj. Jak tylko do³¹czysz do króregoœ z innych obozów, pozostali Najemnicy ciê z tej chaty wyrzuc¹.
	AI_Output(self,other,"DIA_Gorn_HutFree_09_03");	//Ch³opakom niezbyt podoba siê widok Stra¿nika wyleguj¹cego siê w naszej chacie.
...
instance DIA_Gorn_TRADE(C_Info)
{
	...
	permanent = 1;
	description = "Masz wiêcej tego towaru?";
	trade = 1;
};
...
instance DIA_Gorn_DuHehler(C_Info)
{
	...
	permanent = 0;
	description = "Jak to mo¿liwe, ¿e wzi¹³eœ udzia³ w jednym z napadów zorganizowanych przez tê bandê?";
};
...
{
	AI_Output(other,self,"DIA_Gorn_Ueberfall_15_00");	//Przysy³a mnie Lares.
	AI_Output(self,other,"DIA_Gorn_Ueberfall_09_01");	//A wiêc jesteœ nowym cz³onkiem naszej bandy, co?
	AI_Output(other,self,"DIA_Gorn_Ueberfall_15_02");	//Zgadza siê, tylko dlaczego bierzesz udzia³ w tych wszystkich napadach?
	AI_Output(self,other,"DIA_Gorn_Ueberfall_09_03");	//Stary, nie mogê ci tego powiedzieæ, choæbym chcia³. Lee by siê to z pewnoœci¹ nie spodoba³o.
	AI_Output(other,self,"DIA_Gorn_Ueberfall_15_04");	//Rozumiem.
	AI_Output(self,other,"DIA_Gorn_Ueberfall_09_05");	//To jak, mo¿emy ruszaæ?
	AI_Output(other,self,"DIA_Gorn_Ueberfall_15_06");	//W drogê!
	...
	B_LogEntry(CH2_KONVOINC,"Gorn - Najemnik w s³u¿bie Magów Wody - jest jednym z tych, którzy planuj¹ napad na konwój Starego Obozu. Teraz jedyne co mi pozosta³o to wspólny najazd.");
};
...
{
	AI_Output(self,other,"DIA_Gorn_Done_15_00");	//Wydajesz siê byæ ca³kiem niez³ym wojownikiem.
	AI_Output(self,other,"DIA_Gorn_Done_15_01");	//Ja wrócê znowu do Nowego Obozu.
	AI_Output(self,other,"DIA_Gorn_Done_15_02");	//Myœlê, ¿e chyba nie widzimy siê ostatni raz, prawda?
	AI_Output(self,other,"DIA_Gorn_Done_15_03");	//Mam na sk³adzie jeszcze wiêcej cacuszek z tych napadów. Jeœli chcesz dobiæ targu, to zapraszam.
	AI_Output(self,other,"DIA_Gorn_Done_15_04");	//Tak czy inaczej - do nastêpnego razu.
	...
	B_LogEntry(CH2_KONVOINC,"Gorn by³ pod wra¿eniem moich umiejêtnoœci i twierdzi³, ¿e odwali³em kawa³ dobrej roboty. Po napadzie postanowi³ on wróciæ znowu do obozu.");
};
