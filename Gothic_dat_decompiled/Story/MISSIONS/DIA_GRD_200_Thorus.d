...
func void Info_Thorus_MordragKo_Analyze_Info()
{
	...
	Info_AddChoice(Info_Thorus_MordragKo_Analyze,"Gdzie znajdê Mordraga?",Info_Thorus_MordragKo_Where);
	Mordrag = Hlp_GetNpc(ORG_826_Mordrag);
...
func void Info_Thorus_Give1000Ore_Info()
{
	...
	if(Npc_HasItems(other,ItMiNugget) >= 1000)
	{
		...
		erzbezahlt = TRUE;
		B_LogEntry(CH1_MESSAGEKDF,"Zap³aci³em Thorusowi 1000 bry³ek w zamian za dostêp do zamku. Teraz wreszcie bêdê móg³ dostarczyæ tê wiadomoœæ Magom Ognia.");
	}
	else
	{
...
func void Info_Thorus_Krautbote_Info()
{
	...
	{
		AI_Output(self,other,"Info_Thorus_Krautbote_09_04");	//No jaaasne... A amulet pewnie zgubi³eœ, co? Albo ci ukradli, hê?
	};
};
...
func void GRD_200_Thorus_AUFNAHME_Info()
{
	...
	AI_Output(self,other,"GRD_200_Thorus_AUFNAHME_Info_09_12");	//W zamku dostaniesz swoje pierwsze zadanie.
	AI_Output(self,other,"GRD_200_Thorus_AUFNAHME_Info_09_13");	//Ch³opcom przyda siê twoja pomoc z konwojem. Pomów o tym z Ramonem.
	KDFWache = Hlp_GetNpc(GRD_245_Gardist);
...
{
	AI_Output(self,other,"DIA_Thorus_SCBARON_15_00");	//Ty? Magnatem? Jestem pod wra¿eniem. Niez³e z ciebie zió³ko.
	AI_Output(self,other,"DIA_Thorus_SCBARON_15_01");	//Nigdy w ¿yciu bym nie przypuszcza³, ¿e zajdziesz tak daleko.
	AI_Output(self,other,"DIA_Thorus_SCBARON_15_02");	//Dotar³eœ ju¿ praktycznie na sam szczyt.
	AI_StopProcessInfos(self);
};
