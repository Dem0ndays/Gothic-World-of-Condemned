...
func void Info_GRD_275_PreExit_Info()
{
	...
	AI_Output(other,self,"Info_GRD_275_PreExit_15_02");	//Nie mam zamiaru harowaæ dla was w kopalni.
	AI_Output(self,other,"Info_GRD_275_PreExit_06_03");	//A wiêc jesteœ naszym przysz³ym koleg¹? No, to b¹dŸ dla nas mi³y, bo jutro jeszcze tutaj bêdziemy, hehe.
	AI_Output(other,self,"Info_GRD_275_PreExit_15_04");	//S³ysza³em, ¿e s¹ te¿ przecie¿ jeszcze inne obozy...
	AI_Output(self,other,"Info_GRD_275_PreExit_06_05");	//Ta, ju¿ widzê jak ci siê to udaje, po tym co sob¹ prezentujesz. Zrywaj siê st¹d!
