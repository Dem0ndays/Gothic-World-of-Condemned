...
func void ORG_801_Lares_BringListBack_Info()
{
	...
	AI_Output(self,other,"ORG_801_Lares_BringListBack_15_01");	//Œwietnie! Nastêpne co zrobisz, to przejdziesz siê do Gorna. On ci wszystko o napadzie opowie.
	AI_Output(other,self,"ORG_801_Lares_BringListBack_15_02");	//A co ma z tym Gorn wspólnego?
	AI_Output(self,other,"ORG_801_Lares_BringListBack_15_03");	//Czasami lepiej jest nie wiedzieæ za du¿o. IdŸ ju¿ po prostu i z nim pogadaj.
	if(Npc_GetTrueGuild(hero) != GIL_ORG)
	{
		AI_Output(self,other,"ORG_801_Lares_BringListBack_15_04");	//A tak, do naszych napadów nie bêdziemy brali obcych, logiczne, dlatego pierw bêdziesz musia³ do nas do³¹czyæ.
	};
	Points_NC = Points_NC + 10;
	Lares_BringListBack = LOG_SUCCESS;
	B_LogEntry(CH1_JoinNC,"Lares by³ zadowolony z mojej pracy. Powiedzia³, ¿e powinienem pogadaæ z Gornem w sprawie napadu na konwój. Dopóki jednak nie zostanê Szkodnikiem, nie mam co liczyæ na tê wyprawê zbójeck¹.");
