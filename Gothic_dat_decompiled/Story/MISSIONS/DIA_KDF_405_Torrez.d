...
func void DIA_Torrez_PERM_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Torrez_PERM_04_02");	//Innos z tob¹, bracie.
		AI_Output(self,other,"DIA_Torrez_PERM_04_03");	//Obecnie zajmujê siê magi¹ trzeciego krêgu.
		AI_Output(self,other,"DIA_Torrez_PERM_04_04");	//Ponadto badam wp³yw niektórych magicznych amuletów i pierœcieni.
		AI_Output(self,other,"DIA_Torrez_PERM_04_05");	//Istnieje naprawdê ca³a masa rozmaitych artefaktów, które pokrzepiaj¹ cz³owieka w magiczny sposób.
		AI_Output(self,other,"DIA_Torrez_PERM_04_06");	//Jedne czyni¹ ciê silniejszym, drugie wytrzymalszym, a jeszcze inne podnosz¹ twoje magiczne zdolnoœci.
		AI_Output(self,other,"DIA_Torrez_PERM_04_07");	//Poza tym ca³¹ sw¹ uwagê poœwiêcam Innosowi, bracie.
	};
};
...
func void KDF_405_Torrez_GREET_Info()
{
	...
	AI_Output(self,other,"KDF_405_Torrez_GREET_Info_04_03");	//Jednak oczywiœcie najpierw bêdziesz musia³ wykazaæ siê jako s³uga Innosa, zanim bêdê móg³ sprzedaæ ci nasze runy i zwoje.
	Log_CreateTopic(GE_TraderOC,LOG_NOTE);
	B_LogEntry(GE_TraderOC,"Torrez sprzedaje zwoje z zaklêciami i runy. W ci¹gu dnia znajdê go na dziedziñcu. Pohandluje on ze mn¹ jednak dopiero, kiedy zdecydujê siê do³¹czyæ do Krêgu Ognia.");
	Log_CreateTopic(GE_TeacherOC,LOG_NOTE);
	B_LogEntry(GE_TeacherOC,"Torrez mo¿e mi pokazaæ, jak zwiêkszyæ mój poziom many. W ci¹gu dnia znajdê go na dziedziñcu.");
};
