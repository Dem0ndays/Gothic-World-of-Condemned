...
func void DIA_Guy_MyOwnHut_Info()
{
	...
	AI_StopPointAt(self);
	AI_Output(self,other,"DIA_Guy_MyOwnHut_03_02");	//Tylko od razu ciê uprzedzê - bêdziesz móg³ przej¹æ tê chatê tylko pod warunkiem, ¿e jesteœ tu nowy albo jesteœ cz³onkiem Starego Obozu.
	AI_Output(self,other,"DIA_Guy_MyOwnHut_03_03");	//Stra¿nicy niechêtnie patrz¹ na œwirów z Sekty i Szkodników z Nowego Obozu. Migiem by ciê z tej chaty wykurzyli.
};
...
func void dia_guy_preparefight_info()
{
	if(hanis_bet == TRUE)
	{
		AI_Output(self,other,"DIA_Guy_PrepareFight_15_00");	//Pospiesz siê! Zaraz siê zacznie!
		arena_fight = FALSE;
		AI_StopProcessInfos(self);
