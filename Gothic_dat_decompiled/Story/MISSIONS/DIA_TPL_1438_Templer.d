...
func void Tpl_1438_Templer_WHY_Info()
{
	...
	AI_Output(self,other,"Tpl_1438_Templer_WHY_Info_13_05");	//A poza nim jedynie Baal Orun wie jeszcze, jak mo¿na ugotowaæ zupê z ich ¿uwaczek.
	Log_CreateTopic(GE_TeacherPSI,LOG_NOTE);
	B_LogEntry(GE_TeacherPSI,"Baal Orun mo¿e nauczyæ mnie nieco o gotowaniu. Ponoæ zna przepis na zupê z pe³zacza.");
};
...
func void Tpl_1438_Templer_ZANGEN_Info()
{
	...
	B_LogEntry(GE_TeacherOW,"Jeden ze Stra¿ników Œwi¹tynnych, przesiaduj¹cy w Starej Kopalni na najwy¿szym poziomie, mo¿e mnie nauczyæ, jak pozyskaæ wydzielinê z wnêtrznoœci pe³zaczy.");
};
