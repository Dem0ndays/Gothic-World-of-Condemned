...
{
	AI_Output(self,other,"STT_301_IAN_LOSTDIGGER_Info_15_01");	//Czekaj no. Jeœli rzeczywiœcie chcia³byœ siê na coœ przydaæ, to mia³bym dla ciebie robotê.
	AI_Output(other,self,"STT_301_IAN_LOSTDIGGER_Info_13_02");	//O co chodzi?
	AI_Output(self,other,"STT_301_IAN_LOSTDIGGER_Info_15_02");	//Jakiœ czas temu znikn¹³ nam jeden z Kopaczy. Nazywa siê Garret.
	AI_Output(self,other,"STT_301_IAN_LOSTDIGGER_Info_15_03");	//Pracowa³ przez pewien czas w g³ównym szybie na dole ko³o hutnika. Potem nagle gdzieœ przepad³, kiedy zostaliœmy zaatakowani przez pe³zacze.
	AI_Output(self,other,"STT_301_IAN_LOSTDIGGER_Info_15_04");	//Wiesz, gdyby to by³ jakiœ tam zwyk³y Kopacz, to by³oby mi to na rêkê. Ale niestety facet ma doœwiadczenie w tym co robi i dlatego go tu potrzebujemy.
	AI_Output(self,other,"STT_301_IAN_LOSTDIGGER_Info_15_05");	//Rozgl¹dnij siê za nim. Mo¿e nawet bym i nagrody nie posk¹pi³.
	AI_Output(self,other,"STT_301_IAN_LOSTDIGGER_Info_15_06");	//Zasiêgnij na pocz¹tek jêzyka u kopaczy, którzy s¹ rozeznani w temacie.
	lost_digger = LOG_RUNNING;
	Log_CreateTopic(CH1_LOSTDIGGER,LOG_MISSION);
	Log_SetTopicStatus(CH1_LOSTDIGGER,LOG_RUNNING);
	B_LogEntry(CH1_LOSTDIGGER,"Szef Starej Kopalni - Ian - opowiedzia³ mi o niejakim Kopaczu Garrecie. Ponoæ znikn¹³ gdzieœ jakiœ czas temu, kiedy to g³ówny szyb zosta³ przyciœniêty przez pe³zacze. Sam nie ma pojêcia, gdzie móg³ siê ukryæ Garret, ale jeœli ju¿ ktoœ mia³by wiedzê na ten temat, to tylko Kopacze pracuj¹cy w kopalni.");
};
...
func void stt_301_ian_founddigger_info()
{
	...
	AI_Output(other,self,"STT_301_IAN_FOUNDDIGGER_Info_15_02");	//Nie ¿yje. Znalaz³em go w jednym z bocznych szybów.
	AI_Output(self,other,"STT_301_IAN_FOUNDDIGGER_Info_15_03");	//Co? Masz na to jakiœ dowód?
	AI_Output(other,self,"STT_301_IAN_FOUNDDIGGER_Info_15_04");	//Tak, jego kilof.
	AI_Output(self,other,"STT_301_IAN_FOUNDDIGGER_Info_15_05");	//Do diab³a! I TO jest problem. Teraz bêdê musia³ zabiegaæ o to, ¿eby ch³opcy ze Starego Obozu przys³ali mi tu kolejnego Kopacza.
	AI_Output(self,other,"STT_301_IAN_FOUNDDIGGER_Info_15_06");	//Có¿, mimo wszystko dziêkujê ci za pomoc. Proszê, to dla ciebie.
	lost_digger = LOG_SUCCESS;
	Log_SetTopicStatus(CH1_LOSTDIGGER,LOG_SUCCESS);
	B_LogEntry(CH1_LOSTDIGGER,"Ian nie by³ specjalnie zadowolony wieœciami na temat œmierci Garreta. Dla niego jest to kolejny problem, poniewa¿ brakuje mu teraz jednego Kopacza. Mimo to i tak dosta³em nagrodê za to, ¿e mu pomog³em.");
