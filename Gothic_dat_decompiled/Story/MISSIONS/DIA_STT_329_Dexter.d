...
instance info_dexter_gilbert(C_Info)
{
	...
	permanent = 0;
	description = "Znasz mo¿e Gilberta?";
};
...
{
	AI_Output(other,self,"Info_Dexter_Gilbert_07_01");	//Znasz mo¿e Gilberta?
	AI_Output(self,other,"Info_Dexter_Gilbert_07_02");	//Nie, nic mi to nie mówi.
	B_LogEntry(CH1_GILBERT,"Dexter nie zna Gilberta.");
};
...
{
	AI_Output(other,self,"STT_329_Dexter_Sect_15_00");	//A ty co tutaj robisz?
	AI_Output(self,other,"STT_329_Dexter_Sect_11_01");	//Kruk - jeden z Magnatów - poleci³ mi przejœæ siê do obozu na bagnie.
	AI_Output(self,other,"STT_329_Dexter_Sect_15_02");	//No to pomyœla³em, ¿e móg³bym sobie dziêki temu u niego trochê zaplusowaæ, wiêc co mi szkodzi³o.
	AI_Output(self,other,"STT_329_Dexter_Sect_11_03");	//Oczywiœcie dalej mo¿emy ubiæ jakiœ interes. To w koñcu drugi z powodów, dla którego tu jestem.
};
