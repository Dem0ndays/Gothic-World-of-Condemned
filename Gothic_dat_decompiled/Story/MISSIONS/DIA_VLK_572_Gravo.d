...
instance dia_gravo_helpgilbert(C_Info)
{
	...
	permanent = 0;
	description = "Móg³byœ pomóc pewnej osobie?";
};
...
{
	AI_Output(other,self,"DIA_Gravo_HelpGilbert_15_00");	//Móg³byœ pomóc pewnej osobie?
	AI_Output(self,other,"DIA_Gravo_HelpGilbert_04_01");	//A komu¿ to mia³bym pos³u¿yæ ramieniem? I dlaczego sam do mnie nie przyjdzie?
	AI_Output(other,self,"DIA_Gravo_HelpGilbert_04_02");	//Narobi³ sobie zgryzot z ludŸmi Gomeza i dlatego teraz nie mo¿e siê pokazywaæ w obozie.
	AI_Output(self,other,"DIA_Gravo_HelpGilbert_04_03");	//A wiêc tak siê sprawy maj¹. No dobrze, pomogê ci, jednak nie za darmo.
	AI_Output(other,self,"DIA_Gravo_HelpGilbert_04_04");	//Ile sobie liczysz?
	AI_Output(self,other,"DIA_Gravo_HelpGilbert_04_05");	//500 bry³ek rudy.
	AI_Output(other,self,"DIA_Gravo_HelpGilbert_04_06");	//500?!
	AI_Output(self,other,"DIA_Gravo_HelpGilbert_04_07");	//W³aœnie dlatego nigdy nie powinieneœ zadzieraæ z ludŸmi Gomeza. ZAWSZE wychodzi dro¿ej.
	B_LogEntry(CH1_GILBERT,"Gravo mo¿e udzieliæ pomocy Gilbertowi, jednak¿e domaga siê 500 bry³ek za swoj¹ pomoc.");
};
...
{
	AI_Output(other,self,"DIA_Gravo_GilbertOre_15_00");	//Mam 500 bry³ek.
	AI_Output(self,other,"DIA_Gravo_GilbertOre_15_01");	//Doprawdy? Poka¿ no.
	if(Npc_HasItems(other,ItMiNugget) >= 500)
	{
		AI_Output(self,other,"DIA_Gravo_GilbertOre_15_02");	//To powinno wystarczyæ. Mo¿esz powiedzieæ swojemu przyjacielowi, ¿e sprawa zosta³a rozwi¹zana.
		AI_Output(self,other,"DIA_Gravo_GilbertOre_15_03");	//Tylko aby nie wspominaj o tym nikomu niepotrzebnie i dzia³aj tak jak dotychczas.
		B_GiveInvItems(hero,self,ItMiNugget,500);
		erz_gegeben = TRUE;
		B_LogEntry(CH1_GILBERT,"Gravo by³ usatysfakcjonowany z zap³aty. Obieca³, ¿e sprawa zostanie za³atwiona. Czas wracaæ do Gilberta i powiedzieæ mu, ¿e mo¿e znowu wracaæ do Starego Obozu.");
	}
	else
	{
		AI_Output(self,other,"DIA_Gravo_GilbertOre_15_04");	//Przykro mi, ch³opcze, ale to nie wystarczy.
		AI_Output(self,other,"DIA_Gravo_GilbertOre_15_05");	//Wróæ, kiedy zdobêdziesz wystarczaj¹c¹ iloœæ rudy.
	};
};
