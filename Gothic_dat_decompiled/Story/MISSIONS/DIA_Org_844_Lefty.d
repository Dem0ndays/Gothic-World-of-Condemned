...
func void dia_lefty_ring_info()
{
	...
	AI_Output(self,other,"DIA_Lefty_Ring_02_03");	//Twój pierœcieñ. Dlaczego wydaje mi siê dziwnie znajomy?
	AI_Output(other,self,"DIA_Lefty_Ring_02_04");	//Có¿...
	AI_Output(self,other,"DIA_Lefty_Ring_02_05");	//Zreszt¹ niewa¿ne. Wygl¹da na wartoœciowy. Tak czy siak ktoœ taki jak ty pewnie nie bêdzie mia³ co z nim pocz¹æ, wiêc mo¿e grzecznie po prostu oddasz go mnie?
	AI_Output(other,self,"DIA_Lefty_Ring_02_06");	//Hm, pewnie. Trzymaj.
	AI_Output(self,other,"DIA_Lefty_Ring_02_07");	//Dziêki. Hehe. A teraz zabieraj dupsko z powrotem na pola!
	B_GiveInvItems(other,self,ricelords_ring,1);
	AI_StopProcessInfos(self);
	B_LogEntry(CH1_RICELORD,"Dosyæ ³atwo mi posz³o z Lewusem. Sam z siebie zainteresowa³ siê pierœcieniem, kiedy tylko go zobaczy³. Ogólnie rzecz bior¹c nie mia³em nic przeciwko, ¿eby mu go oddaæ.");
};
