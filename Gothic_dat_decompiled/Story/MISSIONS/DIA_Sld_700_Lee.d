...
func void Sld_700_Lee_BECOMESLDNOW_NOOTHER()
{
	...
	AI_Output(self,other,"Sld_700_Lee_CHANGESIDE_Info_08_05");	//Mo¿esz od teraz odbieraæ swój ¿o³d ka¿dego dnia. 10 bry³ek - sta³a p³aca dla ka¿dego Najemnika. Jutro dostaniesz pierwsz¹ wyp³atê.
...
{
	AI_Output(other,self,"DIA_LEE_BUYARMORH_15_00");	//Chcia³bym dostaæ ciê¿k¹ zbrojê.
	if(Kapitel < 4)
	{
...
instance DIA_LEE_DAILYSOLD(C_Info)
{
	...
	permanent = 1;
	description = "Przyszed³em po swoje codzienne wynagrodzenie.";
};
...
{
	AI_Output(other,self,"DIA_Lee_DailySold_15_00");	//Przyszed³em po swoje codzienne wynagrodzenie.
	if(lee_soldday != Wld_GetDay())
	{
		AI_Output(self,other,"DIA_Lee_DailySold_05_01");	//Oczywiœcie. Oto twoje 10 bry³ek. Tyle dostaje ka¿dy Najemnik.
	...
	{
		AI_Output(self,other,"DIA_Lee_DailySold_05_02");	//Dzisiaj nic ju¿ dla ciebie nie mam. Wróæ jutro.
	};
};
