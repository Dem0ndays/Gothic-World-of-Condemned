...
func void Info_Jackal_PAYDAY_Info()
{
	...
	{
		AI_Output(self,other,"Info_Jackal_PAYDAY_11_05");	//Patrzcie pañstwo. Dawny cz³onek naszego obozu.
		AI_Output(self,other,"Info_Jackal_PAYDAY_11_06");	//Gdybyœ wykaza³ wtedy choæ odrobinê rozs¹dku, móg³byœ teraz byæ po stronie zwyciêzców... po NASZEJ stronie!
	}
	else
	{
...
instance info_jackal_gilbert(C_Info)
{
	...
	permanent = 0;
	description = "Kojarzysz mo¿e goœcia o imieniu Gilbert?";
};
...
{
	AI_Output(other,self,"Info_Jackal_Gilbert_07_01");	//Kojarzysz mo¿e goœcia o imieniu Gilbert?
	AI_Output(self,other,"Info_Jackal_Gilbert_07_02");	//W rzeczy samej. Do niedawna by³ zwyk³ym Kopaczem z targowiska.
	AI_Output(self,other,"Info_Jackal_Gilbert_07_03");	//Ale potem narobi³ sobie nie lada problemów z Magnatami, nie mam pojêcia o co chodzi³o.
	AI_Output(self,other,"Info_Jackal_Gilbert_07_04");	//Fina³ tej historii by³ taki, ¿e Gilbert po prostu zabra³ dupê w troki.
	AI_Output(self,other,"Info_Jackal_Gilbert_07_05");	//Od tego czasu ju¿ go tu wiêcej nie widzia³em.
	B_LogEntry(CH1_GILBERT,"Szakal, jeden ze Stra¿ników, pamiêta jeszcze doœæ dobrze Gilberta. Twierdzi, ¿e Gilbert narobi³ sobie problemów z Magnatami, a¿ w koñcu postanowi³ siê ulotniæ.");
};
