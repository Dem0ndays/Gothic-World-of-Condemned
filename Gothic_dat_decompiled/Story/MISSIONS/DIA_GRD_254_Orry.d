...
func void DIA_Orry_OldCamp_Info()
{
	...
	if(Npc_GetTrueGuild(hero) == GIL_None)
	{
		...
		B_LogEntry(CH1_JoinOC,"Stra¿nik Orry opowiada³ mi, ¿e ka¿dy, kto tu trafi, zaczyna jako Kopacz. Jeœli oczywiœcie wyka¿ê siê wiêkszymi ambicjami, móg³bym spróbowaæ zaci¹gn¹æ siê do Cieni.");
	};
};
...
func void DIA_Orry_Waffe_Info()
{
	...
	AI_Output(self,other,"DIA_Orry_Waffe_06_04");	//Ach, i jeszcze coœ...
	AI_Output(self,other,"DIA_Orry_Waffe_06_05");	//Niewykluczone, ¿e znajdziesz te¿ po drodze parê innych rzeczy, takie jak na przyk³ad stare monety.
	AI_Output(self,other,"DIA_Orry_Waffe_06_06");	//Z tego co wiem, to Diego para siê ich zbieraniem.
	AI_Output(self,other,"DIA_Orry_Waffe_06_07");	//Jeœli nie bêdziesz wiedzia³ co z nimi zrobiæ, to powinieneœ siê z tym w³aœnie zwróciæ do Diego. Na pewno coœ ci za nie odpali.
};
...
{
	AI_Output(self,other,"DIA_Orry_Message_15_00");	//Skoro wybierasz siê do Starego Obozu, móg³byœ mi wyœwiadczyæ pewn¹ przys³ugê.
	AI_Output(self,other,"DIA_Orry_Message_15_01");	//Chodzi tylko po prostu o to, byœ przekaza³ wiadomoœæ.
	AI_Output(self,other,"DIA_Orry_Message_15_02");	//Jest taki goœæ w Starym Obozie, nazywa siê Pacho. Jak go kiedy spotkasz, przeka¿ mu, ¿e jestem nastêpny w kolejce.
	AI_Output(self,other,"DIA_Orry_Message_15_03");	//Po prostu mu to powiedz. Bêdzie wiedzia³, o co chodzi.
	orry_message = LOG_RUNNING;
	Log_CreateTopic(CH1_MESSAGEPACHO,LOG_MISSION);
	B_LogEntry(CH1_MESSAGEPACHO,"Stra¿nik Orry zleci³ mi przekazanie wiadomoœci pewnemu cz³owiekowi imieniem Pacho. Jeœli go kiedyœ spotkam po drodze, mam mu powiedzieæ, ¿e Orry jest nastêpny w kolejce - cokolwiek to znaczy.");
