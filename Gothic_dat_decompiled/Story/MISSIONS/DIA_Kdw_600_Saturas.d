...
{
	AI_Output(self,other,"DIA_KDW_Saturas_HeroDMB_15_00");	//TY? Kto ciê nauczy³ mrocznej magii?
	AI_Output(self,other,"DIA_KDW_Saturas_HeroDMB_15_01");	//Albo nie, nie chcê tego wiedzieæ, ani ciê ju¿ tutaj wiêcej widzieæ.
	AI_Output(self,other,"DIA_KDW_Saturas_HeroDMB_15_02");	//Zabieraj siê st¹d!
	AI_StopProcessInfos(self);
};
