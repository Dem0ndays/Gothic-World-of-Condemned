...
instance STT_300_Alberto_BUY(C_Info)
{
	...
	important = 0;
	permanent = 1;
	description = "Mo¿e masz coœ, co chcia³byœ sprzedaæ?";
	trade = 1;
};
...
func void STT_300_Alberto_BUY_Info()
{
	...
	if(alberto_trade == FALSE)
	{
		...
		B_LogEntry(GE_TraderOW,"Alberto - jeden z Cieni w Starej Kopalni - zajmuje siê handlem w tej¿e kopalni. Mo¿na go znaleŸæ na g³ównym poziomie.");
		alberto_trade = TRUE;
	};
};
