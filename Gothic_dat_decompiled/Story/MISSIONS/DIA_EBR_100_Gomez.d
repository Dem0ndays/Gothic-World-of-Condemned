...
func void DIA_Gomez_Hello_Kontakte()
{
	...
	{
		Info_AddChoice(DIA_Gomez_Hello,"Z Lee.",dia_gomez_hello_kontakte_lee);
	};
...
{
	AI_Output(other,self,"DIA_Gomez_Hello_Kontakte_Lee_15_00");	//Z Lee.
	AI_Output(self,other,"DIA_Gomez_Hello_Kontakte_Lee_11_01");	//A wiêc Lee jest twoim poczciwym przyjacielem, co?
	AI_Output(self,other,"DIA_Gomez_Hello_Kontakte_Lee_11_02");	//W takim razie to oczywiœcie zmienia postaæ rzeczy...
	AI_StopProcessInfos(self);
	Npc_SetPermAttitude(self,ATT_HOSTILE);
	Npc_SetTarget(self,other);
	AI_StartState(self,ZS_Attack,1,"");
