...
const string MOBNAME_ORE = "Z³o¿e rudy";
...
const string TXT_SPELLS[59] =
{
	...
	"Teleport, Magowie Wody",
	"Teleport, Nekromanta",
	"Teleport, Orkowie",
	"Teleport, Bractwo",
	"Przemiana w krwiopijcê",
	"n/a",
	"Przemiana w pe³zacza",
	"Przemiana w topielca",
	"Przemiana w chrz¹szcza",
	"Przemiana w kretoszczura",
	"Przemiana w orkowego psa",
	"n/a",
	"Przemiana w œcierwojada",
	"n/a",
	"Przemiana w cieniostwora",
	"Przemiana w zêbacza",
	"VPrzemiana w jaszczura",
	"Przemiana w wilka",
	"Grom",
	"Sopel lodu",
	"Piorun kulisty",
...
const string TXT_TALENTS_SKILLS[12] =
{
	...
	"brak|adept|mistrz",
	"brak|adept|mistrz",
	"brak|Kr¹g 1|Kr¹g 2|Kr¹g 3|Kr¹g 4|Kr¹g 5|Kr¹g 6",
	"Nie|Tak",
	"|",
	"|",
	"Nie|Tak"
...
const string NAME_XPGained = "Doœwiadczenie + ";
const string NAME_LevelUp = "Kolejny poziom!";
...
const string _STR_MESSAGE_ITEM_GIVEN = " przedmiot oddany!";
...
const string _STR_MESSAGE_ORE_TAKEN = " Bry³ki zdobyte: ";
...
const string NAME_NAMIBHEAVYNOVICE = "Zbroja Nowicjusza. Broñ 40, Pociski 5, Ogieñ 20";
const string NAME_NAMIBNOVICE = "Lekka zbroja Nowicjusza. Broñ 30, Ogieñ 15";
