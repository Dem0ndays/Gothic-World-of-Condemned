var int mst_default_blackgobbo.mst_default_blackgobbo.inventar_3;
...
prototype Mst_Default_BlackGobbo(C_Npc)
{
	...
	Mst_Default_BlackGobbo.mst_default_blackgobbo.inventar_3 = Hlp_Random(100);
	if(Mst_Default_BlackGobbo.mst_default_blackgobbo.inventar_3 <= 10)
	{
	...
	else if(Mst_Default_BlackGobbo.mst_default_blackgobbo.inventar_3 <= 20)
	{
		CreateInvItems(self,ItFoMuttonRaw,1);
		CreateInvItems(self,ItFo_Plants_Berrys_01,1);
	}
	else if(Mst_Default_BlackGobbo.mst_default_blackgobbo.inventar_3 <= 30)
	{
		CreateInvItems(self,ItFo_Plants_Seraphis_01,1);
		CreateInvItems(self,ItMiNugget,9);
		CreateInvItems(self,ItFo_Plants_Berrys_01,2);
	}
	else if(Mst_Default_BlackGobbo.mst_default_blackgobbo.inventar_3 <= 40)
	{
		CreateInvItems(self,ItMi_Stuff_Barbknife_01,1);
		CreateInvItems(self,ItMiNugget,3);
		CreateInvItems(self,ItMi_Stuff_Pipe_01,1);
	}
	else if(Mst_Default_BlackGobbo.mst_default_blackgobbo.inventar_3 <= 50)
	{
		CreateInvItems(self,ItFo_Plants_Seraphis_01,1);
		CreateInvItems(self,ItMi_Stuff_OldCoin_01,7);
		CreateInvItems(self,ItMi_Stuff_Cup_01,1);
	}
	else if(Mst_Default_BlackGobbo.mst_default_blackgobbo.inventar_3 <= 60)
	{
	...
	else if(Mst_Default_BlackGobbo.mst_default_blackgobbo.inventar_3 <= 70)
	{
		CreateInvItems(self,ItFoMuttonRaw,1);
		CreateInvItems(self,ItMiNugget,16);
		CreateInvItems(self,ItFo_Plants_Berrys_01,2);
	}
	else if(Mst_Default_BlackGobbo.mst_default_blackgobbo.inventar_3 <= 80)
	{
		CreateInvItems(self,ItFo_Plants_Nightshadow_01,2);
		CreateInvItems(self,ItFo_Plants_Berrys_01,2);
	}
	else if(Mst_Default_BlackGobbo.mst_default_blackgobbo.inventar_3 <= 90)
	{
	...
	else if(Mst_Default_BlackGobbo.mst_default_blackgobbo.inventar_3 <= 100)
	{
